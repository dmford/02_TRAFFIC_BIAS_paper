...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\title{Post-Shooting Policing Evidence of Reduced Intensity and Effectiveness in Traffic Stops}
\author{David Ford}
\maketitle
...
If drivers on the road are more worried about a violent police encounter, it stands to reason that they would drive more carefully, and carry less contraband, and for high scrutiny events there is necessarily higher awareness of the violent encounter, which could indeed lead to fewer drivers and fewer stops. \\

As for public attention mechanisms, I am able to infer a few non-causal incentives. With volume decreases seemingly being driven by low scrutiny events, it is unlikely that these decreases are driven by civilian fears or changes in driving patterns, as scrutiny level carries public awareness implications. Turning to police-side incentives, low scrutiny events may feel more personal to the department and its officers. There may be large resource demands which limit their ability to police, there may be more salient risk aversion and feelings of direct responsibility, whereas for nationally publicized events, external and political pressures are more pronounced, which may stabilize stop behaviors while cautioning against escalation and directing additional resources to the department to mitigate resource drains, consistent with my estimates across scrutiny levels. \\

Taken together, my findings show that following the lethal shooting of an unarmed black person by the police, there is a very large decrease in policing intensity as measured by traffic stop volumes, both black and overall. I find suggestive causal evidence that either police are searching black-driven vehicles under a lower evidentiary bar as shown by a decrease in the black hit rate and black-share of hits decreases at the 90\% level, or that black drivers become less likely to carry contraband, suggesting that contraband findings become proportionally less black following a death event. Considering event heterogeneity across scrutiny levels, I find further non-causal evidence that points toward these decreases in the black hit share and hit rate being driven by high scrutiny events, where officers may be reluctant to exacerbate an already-tense situation, and where drivers may be more aware of the death event and thus driving more carefully and carrying less contraband. \\
...
Khan, K. B., \& Davies, P. G. (2017). What influences shooter bias? the effects of suspect race, neighborhood, and clothing on decisions to shoot. Journal of Social Issues, 73(4), 723–743. \url{https://doi.org/10.1111/josi.12245} \\
...
Wooldridge, J. M. (2021). Two-way fixed effects, the two-way mundlak regression, and difference-in-differences estimators. SSRN Electronic Journal. https://doi.org/10.2139/ssrn.3906345  \\
