...
capture log close
log using "3000_code/05_regs/05_SMCL_logs/05d_estudy_int", smcl replace
...
save "2000_data\500_working\14_days\eq4\05d_use_in_loop.dta", replace
...
foreach o in bstop_share bsearch_share bhit_share bsearch_rate bhit_rate bhit_bstop_ratio n_stops n_bstops n_searches n_bsearches n_hits n_bhits {
	...
	use "2000_data\500_working\14_days\eq4\05d_use_in_loop.dta", replace
	...
	* Setting OUTCOME DESCRIPTIONS: 
	...
	display ""
	display "*********************************************************************"
	display "Eq4: Estudy Int, outcome=""`o'"": `o_desc'"
	display "*********************************************************************"
	...
	* running regressions: 
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (date>1) `ifs', a(`i_absorb') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	...
	* Using balanced panel for the rest: 
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (date>1) `ifs1', a(`i_absorb') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	gen e_`o'_`variant' = (e(sample)==1)
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (date>1) `ifs1', a(`i_absorb2') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	gen e_`o'_`variant' = (e(sample)==1)
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (date>1) `ifs1', a(`i_absorb3') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	gen e_`o'_`variant' = (e(sample)==1)
	...
	if ("`o'" == "n_stops") | ("`o'" == "n_bstops") | ("`o'" == "n_searches") | ("`o'" == "n_bsearches") | ("`o'" == "n_hits") | ("`o'" == "n_bhits") {
		...
		reghdfe log_`o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (date>1) `ifs1', a(`i_absorb') cl(num_dept) base resid 
		est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace
		gen e_`o'_`variant' = (e(sample)==1)
	}
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (multi_dept==0) `ifs1', a(`i_absorb') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	gen e_`o'_`variant' = (e(sample)==1)
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (multi_dept==1) `ifs1', a(`i_absorb') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	gen e_`o'_`variant' = (e(sample)==1)
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (statewide==1) `ifs1', a(`i_absorb') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	gen e_`o'_`variant' = (e(sample)==1)
	...
	reghdfe `o' ib26.b_`k'_low ib26.b_`k'_high `aweight' if (statewide==0) `ifs1', a(`i_absorb') cl(num_dept) base resid 
	est save "4000_outputs/`k'_days/eq4/`o'/estudy_int_`variant'`suffix'", replace 
	gen e_`o'_`variant' = (e(sample)==1)

	save "2000_data/500_working/`k'_days/eq4/`o'/e_estudy_int_`variant'`suffix'.dta", replace
}
